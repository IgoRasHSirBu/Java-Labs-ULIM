...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        EuropeanCountry ec1 = new EuropeanCountry("Moldova", 3.35, "Chișinău",
                "Europa", "Republică parlamentară", "Igor Dodon", 33.846, "MDL");
        ...
        EuropeanUnionCountry euc1 = new EuropeanUnionCountry("Franța", 66.628, "Paris",
                "Europa", "Republică semi-prezidențială", "Emmanuel Macron", 674.843, "Euro",1958);
